...
- [Smallsemi](https://gap-packages.github.io/smallsemi/) - a library of small
  semigroups (with A. Distler) deposited GAP package, 2019.
- [libsemigroups][] C++ library, 2020.
- [libsemigroups_cppyy](https://github.com/libsemigroups/libsemigroups_cppyy)
  python package for using [libsemigroups][] via [cppyy](https://cppyy.readthedocs.io/en/latest/) 2020.
